...
#     print("입금의 완료되었습니다. 잔액은 {0}원 입니다.".format(balance + money))
...
# profile(name="유재속", main_lang="파이썬", age=20)
...
#     print("이름:{0}\t나이 : {1}\t".format(name,age), end=" ") #밑에 문장 이어서 출력 end=" "
...
height = int(input("키가 몇이에요?"))
gender = str(input("성별은 뭐에요?"))
